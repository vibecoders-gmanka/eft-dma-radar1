namespace SDK
{
	public readonly partial struct ClassNames
	{
		...
		{
			public const uint ClassName_ClassToken = 0x200251B; // MDToken
		...
		{
			public const uint ClassName_ClassToken = 0x2000634; // MDToken
			public const string ClassName = @"\uE314";
		}

		public readonly partial struct AmmoTemplate
		{
			public const uint ClassName_ClassToken = 0x20028E4; // MDToken
		...
		{
			public const uint ClassName_ClassToken = 0x200169D; // MDToken
			public const uint GetMalfunctionState_MethodToken = 0x6009069; // MDToken
		...
		{
			public const uint ClassName_ClassToken = 0x2002003; // MDToken
		...
		{
			public const uint ClassName_ClassToken = 0x2002CDD; // MDToken
			public const string ClassName = @"\uF018";
		}
		...
		{
			public const uint ClassName_ClassToken = 0x20023DD; // MDToken
