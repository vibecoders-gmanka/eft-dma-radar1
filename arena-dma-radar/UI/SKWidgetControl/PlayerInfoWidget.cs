...
using arena_dma_radar.Tarkov.EFTPlayer;
...
namespace arena_dma_radar.UI.SKWidgetControl
{
    public sealed class PlayerInfoWidget : SKWidget
    {
        ...
        public void Draw(SKCanvas canvas, Player localPlayer, IEnumerable<Player> players)
        {
            ...
            var filteredPlayers = players.OfType<ArenaObservedPlayer>()
            ...
            Title = "Player Info";
            RightTitleInfo = $"Hostiles: {hostileCount} | AI: {aiCount}";
        ...
        private void AppendPlayerData(StringBuilder sb, ArenaObservedPlayer player, Vector3 localPlayerPos)
        {
            ...
            var grp = player.TeamID != -1 ? player.TeamID.ToString() : "--";
