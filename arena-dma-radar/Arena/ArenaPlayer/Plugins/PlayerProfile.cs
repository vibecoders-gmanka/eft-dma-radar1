...
using arena_dma_radar.Arena.API;
using eft_dma_shared.Common.Misc.Data;
using HandyControl.Tools.Extension;
using System.Threading;

namespace arena_dma_radar.Tarkov.EFTPlayer.Plugins
{
    public sealed class PlayerProfile
    {
        private readonly ArenaObservedPlayer _player;
        public PlayerProfile(ArenaObservedPlayer player)
        {
            _player = player;
        }
